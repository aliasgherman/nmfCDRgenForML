...
F_PDCPRATEUMEASSYS = "PDCPRATEU_MEAS_SYSTEM"
...
def parseline(pline, fileformat=234):
    ret = {}
    ret[F_TIME] = pline[1]
    ret[F_EVENT] = "PDCPRATEU"
    ret[F_EVENTNAME] = "PDCP UL MEASUREMENTS"
    pline = pline[2:]
    ...
    try:
        ...
        ret[F_PDCPRATEUMEASSYS] = measSys[measSysInt]
    except:
        ret[F_PDCPRATEUMEASSYS] = "UNK"
        return
    ...
    try:
        ...
        pdcpHeader = ["PDCP_UL_THROUGHPUT", "PDCP_UL_BLOCKS"]
        pdcpTypes = [int, int]

        pdcpRBHeader = ["PDCP_UL_RB_ID", "PDCP_UL_THROUGHPUT_ON_RB", "PDCP_UL_BLOCKS_ON_RB"]
        ...
        print("An exception occurred decoding pdcp ul. ", e)
        return {}
